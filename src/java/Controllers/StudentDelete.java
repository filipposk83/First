...
public class StudentDelete extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StudentDelete at " + request.getContextPath() + "</h1>");
            // if param delete=some_id call StudentDelete(some_id) from Student Service
            id = Integer.parseInt(request.getParameter("delete"));
            if (sts.StudentDelete(id)){
